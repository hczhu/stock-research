...
- ## An unverified account of what sits inside the $65bn
	- **Source and status**: a social-media post on Anthropic pre-IPO positioning, described by its own author as **"pure speculation."** None of it is confirmed by Anthropic and none of it should be recorded as fact. It is kept here because it is a **specific and falsifiable answer to the definitional question this memo argues matters more than the headline** — and because one of its figures collides with an estimate already tracked in the repo.
	- **The claim, in three parts**: Anthropic (1) **switched its ARR accounting from a gross to a net basis**; (2) **excluded Meta** from the \$65bn figure; and (3) **excluded revenue attributed to Chinese distillation** — API consumption by Chinese customers used to distill Claude into their own models. The post puts **Meta above \$5bn of ARR**.
	- **The arithmetic, if the claim is taken at face value**:
		- \$5bn against a \$65bn net base is **~7.7%** of reported run rate, and Meta alone would put the gross-basis figure above **\$70bn**.
		- **It contradicts the tracked estimate.** SemiAnalysis put Meta at **3–5% of revenue** and described the spend as **"nine figures"** — see [[2026-07-07-semianalysis-anthropic-ipo-financials-profitability]]. Those two descriptors were already inconsistent with each other: 3–5% of a >\$60bn base is **\$1.8–3.0bn**, which is ten figures, not nine. The new claim sits **above** the percentage-derived range and **5×+ above** the dollar description.
		- **The May-to-July comparison may not be like-for-like.** If the \$47bn May figure was struck on the old gross basis and the \$65bn July figure on the new net basis, the reported **+38.3%** understates underlying growth — the gross July number would be **+49% or more**. If both are net, nothing changes. The memo cannot tell which, and that is precisely the problem.
	- **Why the two exclusions are the same kind of exclusion**: both remove revenue that is **structurally impermanent rather than merely lumpy**. Meta is simultaneously Anthropic's largest customer and a competitor building rival coding models — the "three exposures in one holding" framing in [[2026-07-13-semianalysis-anthropic-ipo-financials-tokenomics]]. Chinese distillation revenue is adversarial by construction: the customer is paying to build its own substitute, and it carries export-control and regulatory optics no US S-1 wants to carry.
	- **The strategic logic the post proposes**, which is the interesting part even if the numbers are wrong: excluding Meta does two things at once. It lets Anthropic **absorb a post-IPO Meta cutoff without missing a public number**, and it **reduces Meta's incentive to cut them off at all**, because severing the relationship would no longer damage a reported figure. The post conditions the second effect on the quality of Meta's own model, referred to by a "watermelon" codename.
	- **How to read it if true**: a company that voluntarily **shrinks its own headline number ahead of an IPO** is inverting the usual pre-IPO incentive, and the signal is that the residual is durable. That would make the \$65bn a **higher-quality figure than the \$47bn it is being compared against** — bullish on revenue quality, bearish on headline comparability, and a reason to treat the ARR series in [[2026-06-02-anthropic-arr-growth-milestones]] as containing a basis break.
	- **What would settle it**: the S-1 defining ARR and stating its exclusions; any named-customer or China-exposure concentration disclosure; or Anthropic restating prior-period ARR on the new basis.
